...
| [0008](0008-cctv-mantenimiento-refresco/spec.md) | CCTV/Mantenimiento: la ventana de ejecución no refleja cambios de Trello | Borrador | `cctv-automation-final`, CRM_Frontend |
| [0009](0009-bots-tiempo-real-rediseno/spec.md) | Bots Gane Palmira: tiempo real y rediseño premium | Validada | CRM_Frontend, `chatbot-analytics` |
