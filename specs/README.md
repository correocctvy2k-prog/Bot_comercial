...
| [0011](0011-eventos-diarios-operacion/spec.md) | CCTV/Eventos diarios: operación por zona, conciliación y resolución | Publicada | `cctv-automation-final`, CRM_Frontend |
| [0012](0012-sync-puntos-cctv/spec.md) | Sincronización Operación de Puntos ↔ Seguridad Electrónica (CCTV) | Validada | `cctv-automation-final`, Supabase (`puntos_venta`) |
