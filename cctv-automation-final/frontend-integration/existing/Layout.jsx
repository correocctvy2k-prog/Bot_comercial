...
import { Bot, MapPin, Users, Settings, LogOut, Cable, Terminal, PanelLeftClose, PanelLeftOpen, ChevronDown, ChevronRight, PieChart, Sparkles, Building2, ShieldCheck, User, Image, UserCircle, Loader2, X, Activity, LayoutDashboard, Server, Cctv } from 'lucide-react';
        ...
        items: [
            { to: '/', icon: Bot, label: 'Actividad Bot', module: 'bot-activity' },
            {
                ...
                subItems: [
                    ...
                    { to: '/points/cctv', icon: Cctv, label: 'CCTV Inteligente', module: 'points' }
                ]
            },
...
export default function Layout({ children }) {
    ...
    const [openMenus, setOpenMenus] = useState({ 'Puntos de Venta': true, 'Configuraciones': true, 'Monitoreo IT': true });
