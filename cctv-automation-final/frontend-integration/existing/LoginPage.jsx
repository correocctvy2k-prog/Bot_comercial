...
export default function LoginPage() {
    ...
    const handleForgotPassword = async () => {
        const email = window.prompt('Ingresa el correo asociado a tu cuenta de Skylab:');
        if (!email) return;
        setLoading(true);
        try {
            ...
            toast.success('Solicitud enviada', {
                description: 'Revisa la bandeja de entrada y el correo no deseado. Puedes ingresar con el correo; no necesitas recordar el usuario.',
                duration: 8000,
            });
        } catch (error) {
